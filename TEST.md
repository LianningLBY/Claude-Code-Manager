...
| `test_add_apibest_builds_private_dual_provider_home` / `test_apibest_empty_authenticated_models_falls_back_to_pricing_catalog` | APIBest 双 provider 私有账号目录，以及「认证 models 空目录 → 公开 pricing 模型发现」链路 |
