...
describe('FilesPage managed SSH workspace', () => {
  ...
  it('browses through a managed profile id and keeps legacy connections separate', async () => {
    ...
    expect(screen.getByText('Legacy browser-only connections')).toBeInTheDocument();
