...
- The tag is visible and editable from both the Task list card and the Chat
  header.
...
existing pill or the overflow action, and refreshes after success. `ChatView`
places the compact form in header row two and calls its existing
